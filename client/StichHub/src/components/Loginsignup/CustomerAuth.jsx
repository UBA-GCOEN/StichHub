...
const CustomerAuth = () => {
  ...
  return (
    <div className="bg-gray-800 h-[100vh] flex justify-between ">
      {/* Loading Animations */}
      {isLoading ? (
      ...
      <div className="flex justify-between  sm:w-[65%] mx-auto w-full">
        {/* left Side */}
        <div className="relative bg-primary w-full  lg:w-[100%] my-10 ">
          <div className="relative z-[5]">
            ...
            <div className="flex  justify-center">
              <form onSubmit={handleSumbmit}>
                ...
                <h1 className="text-center text-white text-md pt-1">
        ...
        {/* Right Side (img)*/}
        <div className="hidden lg:flex bg-[url('../src/assets/loginsignupbg.png')] bg-contain bg-no-repeat bg-[#BADDF1] bg-center w-[100%] my-10 ">
          <img
            src={shortlogo}
