...
export default function TabsM(props) {
  ...
  return (
    <Tab.Group>
      <Tab.List className="flex space-x-1 rounded-xl bg-blue-900/20 m-4 drop-shadow-lg">
      ...
      <Tab.Panels className="p-2 border-[1px] border-[gray] w-11/12 justify-center items-center m-auto rounded-lg">
        <Tab.Panel
