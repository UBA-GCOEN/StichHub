...
function ShirtModel(props) {
  ...
  const { sleeveType, collarType, backType, cuffType, selectedColor } = useCCustomization();
  return (
    <group {...props} dispose={null}>
      ...
      {/* collar1 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={collarType.typeName === "Collar 1"}>
        {/* collar inner cloth */}
        <mesh
      ...
      {/* collar2 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={collarType.typeName === "Collar 2"}>
        {/* collar design buttons */}
        <mesh
      ...
      {/* collar3 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={collarType.typeName === "Collar 3"}>
        {/* collar design buttons */}
        <mesh
      ...
      {/* collar4 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={collarType.typeName === "Collar 4"}>
        {/* collar design buttons */}
        <mesh
      ...
      {/* collar6 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={collarType.typeName === "Collar 5"}>
        {/* collar design buttons */}
        <mesh
      ...
      {/* cuff1 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={sleeveType.typeName === "Sleeve 1" && cuffType.typeName === "Cuff 1"}>
        {/* Cuff cloth */}
        <mesh
      ...
      {/* cuff2 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={sleeveType.typeName === "Sleeve 1"&& cuffType.typeName === "Cuff 2"}>
        {/* Cuff cloth */}
        <mesh
      ...
      {/* cuff3 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={sleeveType.typeName === "Sleeve 1" && cuffType.typeName === "Cuff 3"}>
        {/* Cuff cloth */}
        <mesh
      ...
      {/* sleeve1 */}
      <group rotation={[Math.PI / 2, 0, 0]} visible={sleeveType.typeName === "Sleeve 1"}>
        {/* sleeve button cloth */}
        <mesh
