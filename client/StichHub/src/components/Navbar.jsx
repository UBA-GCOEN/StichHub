  ...
  return (
    <div className="bg-black ">
      ...
      >
        ...
        <a
          href="#"
          className="hidden lg:block text-2sm font-semibold leading-6 text-gray-900 px-14"
        >
          Home
        </a>
        ...
        <div className="hidden lg:flex lg:gap-x-12">
          <div className="relative">
            <button
              type="button"
              className="flex items-center gap-x-1 text-2sm font-semibold leading-6 text-gray-900"
              aria-expanded="false"
              onClick={handleClick}
            >
              Our Services
