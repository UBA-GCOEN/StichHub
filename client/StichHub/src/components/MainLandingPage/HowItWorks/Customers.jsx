      ...
      <div className="relative z-[5] ">
        ...
        <div id="steps" className="hidden lg:flex justify-evenly">
          ...
          {hiwcustomer.map((item, index) => (
            ...
            >
              ...
              <img loading="lazy" id="stepLogo" src={item.img} className="mx-[80px] my-[50px] lg:w-[80px]" alt="step logo"/>
        ...
        <div id="steps" className="lg:hidden flex flex-wrap justify-between">
          ...
          {hiwcustomer.map((item, index) => (
            ...
            >
              ...
              <img loading="lazy" id="stepLogo" src={item.img} className="mx-[45px] lg:mx-[80px] lg:my-[50px]" alt="step logo"/>
        ...
        <div id="or" className="relative flex flex-col mt-20">
          ...
          <div id="orContent" className="flex justify-center pt-5">
            ...
            <img loading="lazy" src={appointment} alt="appointment"/>
          </div>
        </div>
      </div>
