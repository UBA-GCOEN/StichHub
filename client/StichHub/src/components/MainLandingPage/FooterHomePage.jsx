...
<ul className="social_icon">
  <li><a href="mailto:stichhub.office@gmail.com" className="text-white px-3"><MailIcon className="text-white text-2xl hover-glow-mail" /></a></li>
  <li> <a href="https://github.com/UBA-GCOEN/StichHub" className="text-white px-3"><GitHubIcon className="text-white text-2xl hover-glow-github" /></a></li>
  <li><a href="https://www.youtube.com/watch?v=dE3RYo23eSY" className="text-white px-3"><YouTubeIcon className="text-white text-2xl hover-glow-youtube" /></a></li>
  <li><a href="https://www.instagram.com/stichhub_/" className="text-white px-3"><InstagramIcon className="text-white text-2xl hover-glow-instagram" /></a></li>
  <li><a href="https://twitter.com/StichHub_" id="social-tw"><TwitterIcon className="text-white text-2xl hover-glow-twitter" /></a></li>
