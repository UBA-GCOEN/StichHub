...
const TopDisplays = () => {
    return (
        ...
        <div className="flex items-center m-4 ml-8 rounded-2xl h-max w-max bg-gradient-to-br from-grey to-dark_grey">
         ...
         <div className="grid justify-items-start grid-cols-1 gap-3 p-5">
            ...
            <div className="text-xs text-white font-medium mt-auto mb-0">
             Updated hour ago
            </div>
         </div>
         ...
         <div className="grid place-items-center gap-3 p-4">
           ...
           <ArrowRightIcon className="h-[25px] w-[25px] fill-white">
