...
const Profile = () => {
  ...
  const Step1 = () => {
    ...
    const [value, setValue] = useState();
    return (
      <div className="ml-[10%] mt-0 mr-20">
        <div className="mb-5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 ">
          ...
          <div xs={5}>
            <div className="mb-2 col-start-1 col-end-2 mr-5">
              <label>
          ...
          <div xs={7}>
            <div className="mb-2 col-start-2 col-end-3">
              <label>
        ...
        <button className="bg-gray-300 w-[30%] mr-5  px-6 py-1.5 rounded-lg text-gray-700 hover:bg-gray-400 top-0">
          Edit
        </button>
        <button
    ...
    return (
      <div className="ml-[7%]" >
        <div className="">
          ...
          <span className="text-lg font-bold">Choose Specialities</span>
          <div className="flex flex-row gap-2 mt-3">
          <div id="alert-1" class="flex w-fit flex border border-blue-700 p-2 mb-4 text-blue-800 rounded-lg bg-blue-50" role="alert">
  <div class="ml-3 text-sm font-medium">
    Women's tailor
  </div>
    <button type="button" class="ml-auto -mx-1.5 -my-1.5 bg-blue-50 text-blue-500 rounded-lg  p-1.5 hover:bg-blue-200 inline-flex h-8 w-8 " data-dismiss-target="#alert-1" aria-label="Close">
      <span class="sr-only">Close</span>
      <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
  </button>
</div>
<div id="alert-1" class=" w-fit flex border border-blue-700 p-2 mb-4 text-blue-800 rounded-lg bg-blue-50" role="alert">
  <div class="ml-3 text-sm font-medium">
    Men's tailor
  </div>
...
<div className="mr-14 rounded-lg border mb-3">
          <Select
            ...
            classNames={{
              menuButton: (state) =>
                "ml--5 flex text-sm pl-5 font-semibold text-gray-500 border border-gray-300 rounded shadow-sm transition-all duration-300 focus:outline-none bg-white hover:border-gray-400 focus:border-blue-500 focus:ring focus:ring-blue-500/20",
        ...
        <div className='multi-range-slider-container mr-14'>
				<b className="text-lg ">Pricing Range</b><br/>
				<b className="text-sm font-normal">(All given Ranges are in rupees(₹))</b>
          ...
          className="border border-white"
				...
				<div className="" style={{ display: 'flex', justifyContent: 'center' }}>
					<div className="font-semibold" style={{ margin: '10px' }}>Your Selected Range:</div>
					<div className="font-bold" style={{ margin: '10px' }}>{minValue}</div>
					<div className="font-bold" style={{ margin: '10px' }}>{maxValue}</div>
				</div>
			</div>
      <div xs={7}>
            <div className="mb-2 col-start-2 col-end-3 mr-14">
              <label>
                <span className="text-gray-700">Description/ Bio</span>
                <br />
                <textarea
                  name="state"
        ...
        <button
          className="bg-gray-300 w-[20%] mr-5 px-6 py-1.5 rounded-lg text-gray-700 hover:bg-gray-400 top-0"
          onClick={handleBack}
        >
          Previous
        </button>
        <button
          className="bg-blue-500 w-[20%] px-6 py-1.5 rounded-lg text-white hover:bg-blue-600"
          onClick={handleNext}
  ...
  return (
    <div className="bg-primary ">
      <Navbardark />
      <div className="bg-white rounded-xl h-[70%] w-[70%] ml-[20%] pt-1">
        {/* Stepper Definition  */}
        <MainContainer>
